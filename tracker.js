(function(){
  ...
  function logToGitHub(type, data){
    ...
    fetch('https://api.github.com/repos/ucfzem/lingotech/issues', {
      method: 'POST',
      headers: {
  ...
  function fetchGitHubIssues(label){
    ...
    return fetch('https://api.github.com/repos/ucfzem/lingotech/issues?labels=' + label + '&state=all&per_page=100', {
